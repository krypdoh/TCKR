            ...
            def on_open(ws):
                ...
                try:
                    if self.queued_subscriptions:
                        # Only subscribe to finnhub symbols (filter out Yahoo symbols)
...
class TickerWindow(QtWidgets.QWidget):
    ...
    def build_ticker_pixmaps(self):
        ...
        # Always insert market status first so it's visible on the first loop
