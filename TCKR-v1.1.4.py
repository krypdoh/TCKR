...
class TickerGLWidget(QtWidgets.QWidget):  # Changed from QOpenGLWidget to QWidget
    def __init__(self, parent):
        ...
        self._vsync_thread.vsync.connect(self.update, QtCore.Qt.QueuedConnection)
    ...
    def _safe_vsync_disconnect(self):
        ...
        try:
            self._vsync_thread.vsync.disconnect(self.update)
        except Exception:
...
class TickerWindow(QtWidgets.QWidget):
    ...
    def paint_ticker(self, widget):
        ...
        # One missed frame (16.7ms) is the worst normal case; anything larger means
        # a stall occurred and we should absorb it as a brief slowdown, not a lurch.
        delta_time = min(delta_time, 0.017)
