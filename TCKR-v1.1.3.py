...
class TickerGLWidget(QtWidgets.QWidget):  # Changed from QOpenGLWidget to QWidget
    def __init__(self, parent):
        ...
        self._vsync_thread = _VSyncThread(self)
        self._vsync_thread.vsync.connect(self.update, QtCore.Qt.QueuedConnection)
        self._vsync_thread.start()
        # Stop the thread cleanly when this widget is destroyed
        self.destroyed.connect(self._vsync_thread.stop)
