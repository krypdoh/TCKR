...
class TickerWindow(QtWidgets.QWidget):
    ...
    def refresh_websocket_visuals(self):
        ...
        try:
            updates_sent = self.websocket_client.process_buffered_updates(max_symbols=batch_size)
            
            # Step 3: Rebuild visual display with all new prices
