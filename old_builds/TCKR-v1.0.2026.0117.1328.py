...
def get_market_status_info():
    ...
    if USE_OPT:
        ...
        if market_open:
            ...
            return ("Market:", QtGui.QColor("#00B3FF"), "Closed", QtGui.QColor("#FF4444"))
...
class TrayIcon(QtWidgets.QSystemTrayIcon):
    ...
    def show_about(self):
        ...
        # Version
        version = QtWidgets.QLabel("Version 1.0.2026.0117.1328")
        ...
        for tkr in self.stocks:
            ...
            if price is not None and prev is not None:
                if USE_OPT:
                    ...
                    price_color = QtGui.QColor("#FF4444")
                else:
