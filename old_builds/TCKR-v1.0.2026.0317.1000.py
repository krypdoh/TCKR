...
class SettingsDialog(QtWidgets.QDialog):
    def __init__(self, parent=None, tray_icon=None):
        ...
        update_interval_layout.setSpacing(16)
        ...
        ws_refresh_field_label = make_row_label("Websocket Visual Refresh:")
        ...
        update_interval_layout.addSpacing(8)
        update_interval_layout.addWidget(ws_refresh_field_label)
        update_interval_layout.addWidget(self.ws_refresh_spin)
        update_interval_layout.addWidget(make_unit_label("sec"))
        ...
        self.second_ticker_stock_browse_btn.setFixedWidth(56)
        self.second_ticker_stock_browse_btn.setFixedHeight(input_height)
        ...
        dual_ticker_layout.setSpacing(6)
        dual_ticker_layout.setContentsMargins(10, 12, 10, 10)
        ...
        self.cert_file_btn.setFixedWidth(56)
    ...
    def _adjust_initial_height(self):
        ...
        max_height = max(500, int(available.height() * 0.95))
        self.setMinimumHeight(min(640, max_height))
...
class TrayIcon(QtWidgets.QSystemTrayIcon):
    ...
    def show_settings(self):
        ...
        dlg.show()
        QtCore.QTimer.singleShot(0, _center_settings_dialog)
        dlg.raise_()
        dlg.activateWindow()
...
class TickerWindow(QtWidgets.QWidget):
    ...
    def _handle_coordinated_prices(self, prices, had_429, now):
        ...
        # Read the stocks list once (disk I/O) before the loop instead of per-ticker
