...
class TickerWindow(QtWidgets.QWidget):
    ...
    def build_ticker_pixmaps(self):
        ...
        market_icon = None
        market_icon_name = "neon_check.png" if status_text == "Open" else "noen_cross.png"
        market_icon_path = resource_path(market_icon_name)
        if not os.path.exists(market_icon_path) and market_icon_name == "noen_cross.png":
            # Backward-compatible fallback if filename was provided as neon_cross.png
            alt_path = resource_path("neon_cross.png")
            if os.path.exists(alt_path):
                market_icon_path = alt_path
